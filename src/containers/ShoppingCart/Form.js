...
class FormDelivery extends React.Component {
  ...
  submitNonUserForm=()=>{
    this.nonUserForm.current.dispatchEvent(new Event('submit', { cancelable: true }))
  }
  ...
  render() {
    ...
    return (
      <div>
        ...
        {!this.props.user &&
          <Form onSubmit={this.props.handleSubmit} ref={this.nonUserForm}>
            <Form.Group>
